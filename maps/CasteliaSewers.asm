	...
	const CASTELIASEWERS_FOCUS_SASH
...
CasteliaSewers_MapEvents:
	...
	object_event 33, 34, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, CasteliaSewersFocusSash, EVENT_CASTELIA_SEWERS_FOCUS_SASH
