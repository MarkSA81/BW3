	...
	; tm/hm learnset
	tmhm GIGA_IMPACT, SWORDS_DANCE, TOXIC, HIDDEN_POWER, SUNNY_DAY, HYPER_BEAM, LIGHT_SCREEN, PROTECT, RAIN_DANCE, THUNDER_WAVE, THUNDERBOLT, THUNDER, RETURN, DIG, SHADOW_BALL, DOUBLE_TEAM, FLAMETHROWER, DREAM_EATER, REST, ATTRACT, FOCUS_BLAST, CUT, STRENGTH, ZEN_HEADBUTT, FIRE_PUNCH, SIGNAL_BEAM, AQUA_TAIL, ICE_PUNCH, SEED_BOMB, GUNK_SHOT, LOW_SWEEP, SUPER_FANG, THUNDERPUNCH
	; end
