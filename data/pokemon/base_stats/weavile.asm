	...
	; tm/hm learnset
	tmhm GIGA_IMPACT, SWORDS_DANCE, CALM_MIND, TOXIC, HAIL, HIDDEN_POWER, SUNNY_DAY, ICE_BEAM, BLIZZARD, HYPER_BEAM, PROTECT, RAIN_DANCE, RETURN, DIG, SHADOW_BALL, DOUBLE_TEAM, REFLECT, X_SCISSOR, DREAM_EATER, SHADOW_CLAW, REST, ATTRACT, THIEF, FOCUS_BLAST, CUT, SURF, STRENGTH, WATERFALL, IRON_TAIL, HONE_CLAWS, ICY_WIND, ICE_PUNCH, DARK_PULSE, LOW_SWEEP
	; end
